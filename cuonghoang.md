<!DOCTYPE html>
<!-- self create by LTP, fix viewport on mobile -->
<html>
  ...
  <script>
    var settings = {
      particles: {
        ...
        color: "#f10706", // color of particles
      },
      text: {
        font: "25px Arial", // font text
        color: "#fb5533", // color of text
        content: "Thiên Phong", // text content
      }
    };
    ...
    (function (canvas) {
      var context = canvas.getContext('2d'),
        ...
        time;
      // get point on particles with -PI <= t <= PI
    ...
    (function (canvas) {
      ...
      context.fillText(settings.text.content, x, y);
